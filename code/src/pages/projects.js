...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
    return (
        <article className='w-full flex items-center justify-between
            ...
            shadow-2xl p-8 relative rounded-br-2xl'
        >
            <div className='absolute top-0 -right-2 -z-10 w-[100.8%] h-[103%] 
                rounded-[2.2rem] bg-dark rounded-br-3xl'
            />
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6'>
                <span className='text-blue font-medium text-xl '>
                    {type}
                </span>
            ...
            <div className='w-full flex flex-col items-start justify-between mt-4'>
                ...
                <div className='mt-2 flex items-center justify-between w-full'>
                    ...
                    <Link href={link} target="_blank" className='underline
                        underline-offset-2 text-lg font-semibold'
                    >
                        Visit Site
                    </Link>
...
const projects = () => {
    return (
        <>
            ...
            <Head>
                <title>CharlieJ | Projects Page</title>
                <meta name="description" content="any description" />
            </Head>
            <main className='w-full mb-16 flex flex-col items-center justify-center'>
                <Layout className='pt-16'>
                    <AnimatedText text="Imagination Builds Knowledge!" className='!text-6xl mb-16' />
