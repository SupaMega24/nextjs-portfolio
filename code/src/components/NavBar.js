    ...
    return (
        ...
        '>
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                ...
                <nav className='flex items-center justify-center flex-wrap'>
                    ...
                    <button
                        ...
                        className={`mr-24 flex items-center  justify-center rounded-full p-1
                    ...
                    <motion.a href="https://github.com/SupaMega24" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className='w-6 mx-3'
                    >
                    ...
                    <motion.a href="https://www.linkedin.com/in/charliej24/" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className='w-6 ml-3'
                    >
            ...
            {/* mobile menu */}
            {
                isOpen ?
                    <motion.div
                        initial={{ scale: 0, opacity: 0, x: "-50", y: "-50" }} //x and y centers modal
                        animate={{ scale: 1, opacity: 1 }}
                        transition={{ duration: 0.5 }} // slows the popout smoothly
                ...
                dark:bg-light/75 dark:text-dark rounded-lg backdrop-blur-md py-32'
                    >
                        <nav className='flex items-center flex-col justify-center'>
                            <CustomMobileLink href="/" title="Home" className='' toggle={handleClick} />
                            <CustomMobileLink href="/about" title="About" className='' toggle={handleClick} />
                            <CustomMobileLink href="/projects" title="Projects" className='' toggle={handleClick} />
                            <a href="https://charliej.hashnode.dev/" target={"_blank"} className='text-light dark:text-dark mb-2 mt-2 '>Articles</a>
                        </nav>
                        ...
                        <nav className='flex items-center justify-center flex-wrap mt-2'>
                            ...
                            <button
                                onClick={() => setMode(mode === "light" ? "dark" : "light")}
                                className={`mr-6 flex items-center  justify-center rounded-full p-1
                    ${mode === "light" ? "bg-dark text-light" : "bg-light text-dark"}
                    `}
                            >
                                {
